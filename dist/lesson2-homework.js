...
function excercise6() {
    ...
    const userJohn = { name: "John", age: 23 };
...
function excercise8() {
    ...
    const printGreeting = (user) => {
        if (user && user.name && typeof user.name === "string") {
            ...
            throw new Error("ArgumentType error");
    };
    // TODO: create a product object, assign it some object literal
    const phone = { name: "Iphone", price: 3000 };
    ...
    printGreeting({ name: "Greg", lastname: "Agrot" });
}
// TODO: compile and run the code
excercise8();
...
function excercise9() {
    ...
    class Magazine extends Book {
         ...
         */
        constructor(day, month, year, title) {
            super(title, year);
            if (month < 1 || month > 12) {
